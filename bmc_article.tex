...
\begin{figure}[h!]
  \caption{\csentence{Manufacturing process of the CNT/CBM composite.}
      }
   \label{fig1}
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{CNT/CBM specimens and copper electrodes mesh type configuration.}
  \label{fig2}
      }
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{a) Electrical connection diagram for ohmic characterization of the CNT/CBM. b) Electrical connection diagram for characterization of the electrical resistance using DC source. c) Electrical connection diagram for characterization of the electrical resistance using BDC.}
      }
  \label{fig3}
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{Experimental setup for CNT/CBM piezoresistivity determination.}
      }
    \label{fig4}
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{RC-beam manufacturing for the validation of the operation of the sensor against the health monitoring. a) CNT/CBM parallelepiped with corrugated steel rods. b) inclusion of the CNC/CBM parallelepiped within the steel frame of the RC-beam. c) Casting over the CNC/CBM parallelepiped and the reinforced steel structure of the concrete for the fabrication of the RC-beam.}
      }
      \label{fig5}
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{ Behavior of the piezoresistive response of the CNT/CBM against the state of damage and no damage for the RC-beam. Dynamic load from 0 to 15 kN.}
      }
      \label{fig11}
      \end{figure}
...
\begin{figure}[h!]
  \caption{\csentence{ Behavior of the CNT/CBM and the FBG sensor as function of time. Dynamic load from 0 to 15 kN.}
      }
      \label{fig12}
      \end{figure}
